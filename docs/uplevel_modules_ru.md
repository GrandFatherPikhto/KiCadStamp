...
## 18. `utils/file_cache.py` — кэш чтения одного файла
...
**Используется в:** `config/includes.py`, `config/loader.py`, `config_writer.py` (чтение и единственная точка записи), `sheet_names.py`.
